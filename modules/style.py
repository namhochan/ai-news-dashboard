...
def inject_base_css() -> str: return """ <style> /* ===== CSS 변수 ===== */ :root{ --gap:10px; --card:#10141d; --bd:#1e2a3d; --txt:#dfe7f5; --muted:#9aa7bd; --muted-2:#8ea3c9; --chip:#2b3a55; --panel:#0f1420; --speed: 30s; --up:#ee6666; --down:#6aa2ff; --shadow: 0 6px 16px rgba(0,0,0,.35); } [data-theme="light"]{ --card:#f7f9ff; --bd:#d9e2f1; --txt:#0f172a; --panel:#ffffff; --chip:#c9d6ee; --muted:#5b6b82; --muted-2:#6b7c96; --shadow: 0 8px 16px rgba(15,23,42,.08); }
...
def render_quick_menu() -> str: return """ <nav class="quick" aria-label="Quick Menu"> <div class="card"> <div class="h">Quick Menu</div> <a href="#sec-ticker">📊 시장 요약</a> <a href="#sec-news">📰 최신 뉴스</a> <a href="#sec-themes">🔥 테마 요약</a> <a href="#sec-top5">🚀 유망 Top5</a> <a href="#sec-judge">🧾 종합 판단</a> </div> </nav> """
